...
originalFile1 = 'edited1.xlsx'
parsedFile = 'edited2.xlsx'
...
testCondsTup = ws[('B') + ':' + ('D')]
testConds = list(testCondsTup)
testConds = testConds.T



#loop through the saved data and see if there		
for irow in range(len(testConds[0])):
	for icol in range(len(testConds)):
